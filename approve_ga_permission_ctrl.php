<?php
	...
	//Az approve_ga.js fajl hivja meg, hogy leellenorizze, hogy van-e az adott felhasznalonak GA jovahagyo jogosultsaga az adott tipusu dokumentumhoz (a TYPE_ID valtozot kuldi parameterkent)
...
//APPROVAL PERMISSION CONTROL QUERY -->
	...
	$query=	"SELECT SUM(APPROVE_GA_P) AS APPR " .
			"FROM " .
			"tUsrPermissionsDO " .
...
//APPROVAL PERMISSION CONTROL -->
	...
	//Amennyiben nincs jogosultsaga, akkor 0 az eredmeny, amit a query visszaad es hibauzenetet kap a felhasznalo (response az approve_ga.js fajlban)
	if($approve_p==0)
	{
		echo '0';
	}
