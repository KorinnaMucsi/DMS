<?php
	...
	$query=	"SELECT ID, TYPE_ID, DOC_TYPE_ID, DESCR, PRINTABLE, " .
			"CASE PDT.ACTIVE WHEN 1 THEN 'Yes' ELSE 'No' END AS ACTIVE " .
			"FROM tPDocTypes PDT " .
			"WHERE 1=1 ";
...
//SORT THE DATA -->
	...
	{
		$e_lnk='<a id="e' . $row['ID'] . '" href="#" onclick="EditPType(\'' . $row['ID']. '\');">Edit</a>';
